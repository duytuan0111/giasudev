<div class="content-inner">
	<form name="frmslider" action="<?php echo site_url('admin/add_viectheomontinhthanh'); ?>" method="post" enctype="multipart/form-data">
		<?php 
			...
			if(isset($subject_id) && isset($subject_id))
			{
				...
				$item=$this->db->get('viecbycitysubject')->row();
