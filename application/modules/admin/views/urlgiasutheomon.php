...
<form name="frmxoaall" id="frmxoaall" method="post" action="">
	...
	<table width="100%" style="display:block;">
		...
		<tr class="<?php echo $stt%2 ? 'odd' : 'even'; ?>">
			...
			<td><a >hồ sơ gia sư dạy kèm <?php echo ($n->SubjectName); ?></a></td>	<!--href="<?php echo site_url('admin/edit_vieclam/'.$item->UserID); ?>"-->		
			<td><a href="<?php echo base_url() ?>mon-<?php echo vn_str_filter($n->SubjectName) ?>-m<?php echo $n->ID?>l0t0.html" target="blank"><?php echo base_url() ?>mon-<?php echo vn_str_filter($n->SubjectName) ?>-m<?php echo $n->ID?>l0t0.html</a></td>			
			<td align="center">						
				<a href="<?php echo site_url('admin/edit_urltheomon/'.$n->ID); ?>" class="btn btn-sm btn-danger">Sửa</a>
			</td> 
