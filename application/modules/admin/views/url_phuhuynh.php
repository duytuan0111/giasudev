...
<form name="frmxoaall" id="frmxoaall" method="post" action="<?php echo site_url('admin/del_urlphuhuynh'); ?>">
	...
	<table width="100%" style="display:block;">
		...
		<tr class="<?php echo $stt%2 ? 'odd' : 'even'; ?>">
			...
			<td>
				<?php if ($n->option == 0) { ?>
					<a href="<?php echo base_url(); ?>tim-viec-lam-gia-su-mon-<?php echo $n->alias ?>.html" target="blank"><?php echo base_url(); ?>tim-viec-lam-gia-su-mon-<?php echo $n->alias ?>.html</a>
				<?php } else if($n->option == 1) { ?>
					<a href="<?php echo base_url(); ?>tim-viec-lam-gia-su-tai-<?php echo $n->alias ?>.html" target="blank"><?php echo base_url(); ?>tim-viec-lam-gia-su-tai-<?php echo $n->alias ?>.html</a>
				<?php } ?>
			</td>			
			<td align="center">						
