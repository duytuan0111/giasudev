                ...
                <div class="listnganhnghe">
                    <ul>  
                         <?php 
                                    if(!empty($monhoc)){
                                        foreach($monhoc as $n){ ?>
                                            <!-- <li class="col-md-4 padd-0"><a target="_blank" href="<?php echo base_url() ?>tim-gia-su&key=all&subject=<?php echo $n->ID ?>&topic=0&place=0&type=0&sex=0"><?php echo $n->SubjectName ?></a></li> -->
                                            <li class="col-md-4 padd-0"><a target="_blank" href="<?php echo base_url() ?>viec-lam-gia-su-mon-<?php echo vn_str_filter($n->SubjectName); ?>-s<?php echo $n->ID ?>c0p0.html"><?php echo $n->SubjectName ?></a></li>
                                        <?php }
                                    }
                         ?>
                    </ul>
