...
if(isset($_SESSION['UserInfo']) || !empty($_SESSION['UserInfo'])){ //TypeUser
...
<style type="text/css">
    ...
    #modalloginteacher .form-control {
        margin-bottom: 10px;
    }
    #modalloginteacher .btn-primary {
        font-weight: 500;
        line-height: 35px;
        padding: 0 20px;
        width: 100%;
    ...
    #modalloginteacher .notifymail {
        position: relative;
        width: 100%;
        margin: 0 auto;
        text-align: center;
    }
    #modalloginteacher .modal-header .modal-title p {
        font-size: 14px;
        margin-top: 10px;
        margin-bottom: 0;
        font-weight: 500;
            ...
            <div class="col-md-10 col-sm-12 padd-l-10">
                <div class="detailjob-header">                    
                    ...
                    <div class="detailjob-social col-md-4 col-sm-12">
                        ...
                        <div class="divbtn">
                        <span class="btn btndenghiday" data-val="<?php echo $item->ClassID ?>">Đề nghị dạy</span>
                        <!-- <span class="btn btnactive">Đăng yêu cầu mới</span> -->
                        </div>
                        <!-- <div class="divbtn">
                        <?php if($type == 1){ ?>
...
<!-- Modal dang nhap -->
 <div class="modal fade" id="modalloginteacher" tabindex="-1" role="dialog" aria-labelledby="modelsendchatLabel" aria-hidden="true">
<div class="modal-dialog" role="document">
<div class="modal-content">
  <div class="modal-header">
    <div class="modal-title">
      <i class="fa fa-warning"></i> Đăng nhập tài khoản gia sư
      <!-- <p>Bạn cần đăng nhập để xem chi tiết lớp của NTD</p> -->
    </div>
  ...
  <div class="modal-body">
    <div class="notifymail">
      ...
      <button type="button" class="btnx btn-primary" id="dangnhapgiasu">Đăng nhập</button>
    </div>
  </div>
    <div class="modal-body">
  ...
  <div class="modal-footer">
      <div class="linkregister">    
            <span>Bạn chưa có tài khoản? <a id="btnregisteruv" href="<?php echo base_url(); ?>dang-ky-gia-su">đăng ký</a></span>
        </div>
  </div>
</div>
</div>
          ...
          $.ajax(
              {
                  ...
                  url: configulr+"/site/ajaxviewcontactinfo1",
                  type: "POST",
                  data: { keyview:trace },
                  dataType: 'json',
                  beforeSend: function () {
            ...
            $.ajax(
              {
                  ...
                  error: function (xhr) {
                      alert("Lưu lớp học không thành công");
                  },
                  complete: function () {
                      $("#boxLoading").hide();
                  }
