...
<div class="container">
    <div class="formlogin frmfogotpass confirmfogot">
        <?php 
          ...
          $url = base_url();
          if (isset($_SESSION['UserInfo']) && !empty($_SESSION['UserInfo']) && ($_SESSION['UserInfo']['Active'] == 0) && ($_SESSION['UserInfo']['UserType'] == 0)) {
        ...
        <div class="fogotmypassword">
            <p>Xin chào <strong><?php echo $info_user['Name']; ?></strong><br />
            Cảm ơn Quý khách đã đăng ký tài khoản Nhà tuyển dụng tại Timviec365.com.vn.<br />
            Để tin tuyển dụng của Quý khách được gửi đến bộ phận kiểm duyệt, vui lòng xác thực Email đăng nhập tài khoản trên Timviec365.com.vn bằng cách truy cập vào Email bạn đã đăng ký.</p><br>
            <p>Nếu hệ thống chưa gửi Email, vui lòng gửi lại Email bằng cách bấm vào nút dưới đây:           
            </p>
            ...
            <div>
                <ul>
                    <li>- Nếu gặp khó khăn, vui lòng liên hệ qua email:<a href="email:ctcpdichvutruyenthonghungviet@gmail.com"> ctcpdichvutruyenthonghungviet@gmail.com</a></li>
                    <li>- Hoặc qua số Hotline: <strong style="">0981509188</strong> để được hỗ trợ</li>
                </ul>
            </div>
        </div>
...
<script>
  jQuery(document).ready(function($) {
    ...
    $('.btnconfirmfogotpass').on('click', function(event) {
      ...
      $.ajax({
        url: configurl+'site/forgetmail2',
        type: 'POST',
        data: {email: email},
