...
$route['tim-lop-hoc(:any)?']="site/AllTeacher";
...
//
// $route['tim-gia-su-(:any)-m(:num)l(:num)t(:num).html(/:num)?']="site/listteacherbyfilter_back/$1/$2/$3/$4";
$route['(:any)-m(:num)l(:num)t(:num).html(/:num)?']="site/listteacherbyfilter_back/$1/$2/$3/$4";
$route['(:any)/(:any)-s(:num)r(:num)c(:num).html(/num)?']="site/listteacherbyfilter_clone/$1/$2/$3/$4/$5";
$route['(:any)/(:any)-c(:num)d(:num).html(/:num)?']="site/listteacherbyfilter_TPHCM/$1/$2/$3/$4";
...
// $route['tim-viec-lam-gia-su-(:any)-s(:num)c(:num)p(:num).html(/:num)?']="site/listclassbyfilter_back/$1/$2/$3/$4";
$route['(:any)-s(:num)c(:num)p(:num).html(/:num)?']="site/listclassbyfilter_back/$1/$2/$3/$4";
// $route['tim-viec-lam-gia-su-(:any)-(:any)-m(:num)c(:num)p(:num).html(/num)?']="site/listclassbyfilter_clone_back/$1/$2/$3/$4/$5"; 
$route['(:any)-(:any)-m(:num)c(:num)p(:num).html(/num)?']="site/listclassbyfilter_clone_back/$1/$2/$3/$4/$5"; 
$route['tim-viec-lam-gia-su-(:any)/(:any)-p(:num)d(:num).html(/:num)?']="site/listclassbyfilter_TPHCM/$1/$2/$3/$4";
...
// $route['tim-gia-su(:any)?']="site/TeacherAll";
// $route['tim-giao-vien-day-kem']="site/TeacherAll";
// $route['tim-giao-vien-day-kem&order=(:any)?(/:num)?']="site/TeacherAll/$1";
$route['tim-gia-su&order=(:any)?(/:num)?']="site/TeacherAll/$1";
$route['tim-gia-su(:any)?(/:num)?']="site/TeacherAll/$1";
...
$route['mn-hv-gia-su-da-xem-thong-tin']="site/mnuserseeinfo";
...
// xac thuc tai khoan
$route['xac-thuc-tai-khoan-ntd'] =  "site/xacthuctaikhoannhatuyendung";
$route['xac-thuc-tai-khoan'] =  "site/xacthuctaikhoangiasu";
