...
<head>
  ...
  ?>
  <meta property="og:url" content="<?php if(isset($canonical)) {echo $canonical;} else {echo base_url();} ?>"/>
  ...
  <meta property="og:image" content="<?php if(isset($url_logo)) {echo $url_logo;} else {echo base_url();} ?>"/>
  ...
  <meta name="robots" content="<?php echo ($robots != '') ? $robots : 'noindex,nofollow'  ?>" />
  <base href="<?php echo base_url(); ?>" />
  <meta name="twitter:card" content="summary" />
  <meta name="twitter:description" content="<?php if(isset($meta_des)){echo $meta_des;} ?>" />
  <meta name="twitter:title" content="<?php if(isset($meta_title)){ ?><?php echo $meta_title; }?>" />	
