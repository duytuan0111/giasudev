...
foreach ($files as $key => $value) {
	...
	if(end($u) == 'xml'){
		...
		$links[] = array('https://timviec365.com.vn/gia-su/'.$file_name,date('Y-m-d\TH:i:sP', filemtime($value)));
		}

		if ($file_name == 'sitemap-page.xml') {
			$url[] = array('https://timviec365.com.vn/gia-su/'.$file_name,date('Y-m-d\TH:i:sP', filemtime($value)));
		}
	}
}
